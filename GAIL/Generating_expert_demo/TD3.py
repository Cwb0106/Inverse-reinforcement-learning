...
class TD3(object):
	...
	def train(self):
		self.delay_counter += 1
		with torch.no_grad():
			s, a, r, s_prime, dead_mask = self.memory.sample(self.Q_batchsize)
	...
	def save(self,episode):
		...
		torch.save(self.q_critic.state_dict(), "TD3_q_critic.pth")


	def load(self,episode):

		self.actor.load_state_dict(torch.load("TD3_actor.pth"))
		self.q_critic.load_state_dict(torch.load("TD3_q_critic.pth"))
